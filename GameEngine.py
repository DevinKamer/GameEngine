...
def create_player():
    ...
    def four_d_six():
        ...
        while not valid:
            print("SCORES: ", daScores)
            inputInt = int(input("Which value for intellegence: "))
        ...
        inputPotionCount = 0
        inputWeapon = Weapon(name = "Long Sword", base = 8, bonus = 0)
        ...
        return Character(name = inputName, strength = inputStr,
                         ...
                         charisma = inputCar, numberOfPotions = inputPotionCount,
                         weapon = inputWeapon, armor = inputArmor, maxHealth = inputHealth)
